...
export type DRW_Version = DRW_VersionValue<0>|DRW_VersionValue<1>|DRW_VersionValue<2>|DRW_VersionValue<3>|DRW_VersionValue<4>|DRW_VersionValue<5>|DRW_VersionValue<6>|DRW_VersionValue<7>|DRW_VersionValue<8>|DRW_VersionValue<9>;

export interface DWR_ErrorValue<T extends number> {
  value: T;
}
export type DWR_Error = DWR_ErrorValue<0>|DWR_ErrorValue<1>|DWR_ErrorValue<2>|DWR_ErrorValue<3>|DWR_ErrorValue<4>|DWR_ErrorValue<5>|DWR_ErrorValue<6>|DWR_ErrorValue<7>|DWR_ErrorValue<8>|DWR_ErrorValue<9>|DWR_ErrorValue<10>|DWR_ErrorValue<11>|DWR_ErrorValue<12>;
...
export interface LEVELValue<T extends number> {
  value: T;
}
export type LEVEL = LEVELValue<0>|LEVELValue<1>;
...
export interface DRW_Header extends ClassHandle {
  ...
  getComments(): string;
  write(_0: dxfWriter | null, _1: DRW_Version): void;
...
export interface DRW_Polyline extends DRW_Point {
  ...
  smoothN: number;
  curvetype: number;
  vertlist: DRW_VertexList;
  addVertex(_0: DRW_Vertex): void;
  appendVertex(_0: DRW_Vertex | null): void;
}
...
export interface DRW_Spline extends DRW_Entity {
  ...
  controllist: DRW_CoordList;
  fitlist: DRW_CoordList;
  applyExtrusion(): void;
}
...
export interface DRW_Hatch extends DRW_Point {
  ...
  scale: number;
  deflines: number;
  looplist: DRW_HatchLoopList;
  appendLoop(_0: DRW_HatchLoop | null): void;
  applyExtrusion(): void;
}
...
export interface dxfRW extends ClassHandle {
  setDebug(_0: DRW_DBG_LEVEL): void;
...
interface EmbindModule {
  dxfWriter: {};
  DRW_Version: {UNKNOWNV: DRW_VersionValue<0>, AC1006: DRW_VersionValue<1>, AC1009: DRW_VersionValue<2>, AC1012: DRW_VersionValue<3>, AC1014: DRW_VersionValue<4>, AC1015: DRW_VersionValue<5>, AC1018: DRW_VersionValue<6>, AC1021: DRW_VersionValue<7>, AC1024: DRW_VersionValue<8>, AC1027: DRW_VersionValue<9>};
  DWR_Error: {BAD_NONE: DWR_ErrorValue<0>, BAD_UNKNOWN: DWR_ErrorValue<1>, BAD_OPEN: DWR_ErrorValue<2>, BAD_VERSION: DWR_ErrorValue<3>, BAD_READ_METADATA: DWR_ErrorValue<4>, BAD_READ_FILE_HEADER: DWR_ErrorValue<5>, BAD_READ_HEADER: DWR_ErrorValue<6>, BAD_READ_HANDLES: DWR_ErrorValue<7>, BAD_READ_CLASSES: DWR_ErrorValue<8>, BAD_READ_TABLES: DWR_ErrorValue<9>, BAD_READ_BLOCKS: DWR_ErrorValue<10>, BAD_READ_ENTITIES: DWR_ErrorValue<11>, BAD_READ_OBJECTS: DWR_ErrorValue<12>};
  ...
  LEVEL: {NONE: LEVELValue<0>, DEBUG: LEVELValue<1>};
  DRW_dbg: {
